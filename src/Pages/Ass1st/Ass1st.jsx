    ...
    <div>
      ...
      <div className="mx-auto container mt-28">
        <div className="px-5 sm:px-10 md:px-20 pt-10 justify-center text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-black">
            ASS1ST
          </h1>
          <div className="text-sm sm:text-base md:text-lg font-medium">
            <h4 className="text-center lg:px-28 mt-10">
              Hello Smukierz, sebentar lagi kita akan segera menapaki perjalanan
              kita di tingkat perkuliahan. Tapi, masih banyak dari kita yang
              ragu akan memilih jurusan kuliah. Tapi jangan khawatir karena kami
              hadir dengan program ASS1ST. Apa itu ASS1ST? ASS1ST ini adalah
              program OSIS bidang 4 yang isinya merupakan penjelasan mengenai
              jurusan kuliah serta nama-nama universitas yang mengusai di
              jurusan tersebut. Jadi, harapannya dengan adanya ASS1ST ini maka
              akan mempermudah kalian dalam menentukan jurusan kuliah yang
              kalian inginkan.
            </h4>
          </div>
          <div className="mt-12">
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/3zfcJS-e_Oo"
              title="How’s it like to study in OHIO?? | UNI ASS1ST VLOG"
          ...
          <div className="text-center px-10 sm:px-16 md:px-20 lg:px-32 xl:px-52 py-16">
            ...
            <div className="grid gap-4 grid-cols-2 lg:grid-cols-3 xl:gap-10 my-16">
              <NavLink to="Kedokteran">
                <AssistNav img={Kedokteran} Title="Kedokteran" />
              </NavLink>
              <NavLink to="Farmasi">
                <AssistNav img={Farmasi} Title="Farmasi" />
              </NavLink>
              <NavLink to="Keguruan">
                <AssistNav img={Keguruan} Title="Keguruan" />
              </NavLink>
              <NavLink to="Sosiologi">
                <AssistNav img={Sosiologi} Title="Sosiologi" />
              </NavLink>
              <NavLink to="Akutansi">
                <AssistNav img={Akutansi} Title="Akutansi" />
              </NavLink>
              <NavLink to="Hukum">
                <AssistNav img={Hukum} Title="Hukum" />
              </NavLink>
              <NavLink to="Psikologi">
                <AssistNav img={Psikologi} Title="Psikologi" />
              </NavLink>
              <NavLink to="Teknik_sipil">
                <AssistNav img={Teknik_sipil} Title="Teknik Sipil" />
              </NavLink>
              <NavLink to="Pertambangan">
                <AssistNav img={Pertambangan} Title="Pertambangan" />
              </NavLink>
            </div>
          </div>
        </div>
