      ...
      <OsisTeam
        ...
        person4={
          <BidangSection
            img={Tristan}
            alt="Tristan"
            name="Tristan Axel Kosen"
            desc="Halo semuaaanya, kenalin aku Tristan Axel Kosen, biasanyaa dipanggil axel ato xel, anggota dari bidang 6. Di waktu kosong biasanya aku olahragaa baskett atau ga pingpongg, kadang main game jugaa kayak pubg sm valo. "
          />
        }
        Description={true}
