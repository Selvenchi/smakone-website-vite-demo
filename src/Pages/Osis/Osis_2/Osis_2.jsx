      ...
      <OsisTeam
        ...
        person2={
          <BidangSection
            img={Joshua}
            alt="Joshua"
            name="Joshua Nathanael Yang"
            desc="Salken, nama aku Joshua, biasa dipanggil Joshua atau Josh. Hobi aku olahraga sih kecuali berenang. Kalo mau ngobrol/tau lebih banyak tentang aku, boleh cek ig aku aja ya @joshua.n.y Nice to meet u all!"
          />
        }
        person3={
          <BidangSection
        ...
        person4={
          <BidangSection
            img={Clairence}
            alt="Clairence"
            name="Clairence Ilona Tanu"
            desc="Hi semuaa, nama aku Clairence Ilona, biasanya dipanggil Claire. Hobi aku bisa dibilang basic sih kayak nonton film, baca buku, sama dengerin musik. Kalo ngomongin musik aku suka artist kayak NIKI sama dewa 19. Aku juga kadang main gitar, tapi sampe sekarang ga jago-jago. Feel free to hit me up di @clairee.ilo !!"
          />
        }
        person5={
          <BidangSection
            ...
            desc="Haii guyss!! 👋🏻👋🏻 Nama aku Jessica Faustine and aku berasal dari kelas 10-3. Sekarang aku berkesempatan menjadi anggota osis bidang 2 ✌🏻🤞🏻. Oiyaa kalian bisa panggil aku Jess F. Hobi aku nonton, main game, sama kadang aku juga suka baking. Fun Fact tentang aku, aku suka banget banget sama matchaa 🍵. Kalauu kalian mau ngobrol/lebih kenal sama aku, bisa dm or follow ig akuu yaah @jessicaftine. Salam kenall guys, enjoy and goodluckk yaa in smukiee 💯🫡😍"
          />
        }
        Description={true}
