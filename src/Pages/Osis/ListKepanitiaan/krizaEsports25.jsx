      ...
      <div className="mt-28 mx-auto">
        ...
        <div className="flex flex-col items-center">
          <p className="text-left w-3/4 ">
            Setelah kami melakukan seleksi selama 5 hari pada,{" "}
            <b>
              {" "}
              Rabu 16 April 2025 - Jumat 18 April 2025 & Selasa 6 Mei 2025,
              Kamis 8 Mei 2025 -{" "}
            </b>
            , telah ditentukan anggota-anggota baru sebagai berikut:
          </p>
        </div>
