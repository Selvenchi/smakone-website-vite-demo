...
const data = [
  ...
  },
  {
    ...
    members: [{ name: "Emily Adelia", kelas: "X6" }],
  },
  {
    bidang: "Konsumsi",
    members: [{ name: "Phoebe Lynelle Budiman", kelas: "X6" }],
  },
  {
    bidang: "Merchandise",
    members: [{ name: "Ivana Roxanne Subakti", kelas: "X1" }],
  },
  {
  ...
  },
  {
    ...
    members: [{ name: "Nicholas Thaddeus", kelas: "XI5" }],
  },
  {
    bidang: "Ticketing",
    members: [
  ...
  {
    bidang: "Transportasi",
    members: [{ name: "Chika Letischa", kelas: "X1" }],
  },
];
      ...
      <div className="mt-28 mx-auto">
        ...
        <div className="flex flex-col items-center ">
          <p className="text-left w-3/4 mb-5">
            Setelah kami melakukan open recruitment selama 6 hari pada{" "}
            <b>Kamis, 22 Mei 2025 - Selasa, 27 Mei 2025,</b> telah ditentukan
            calon anggota baru sebagai berikut:
          </p>
        </div>
      </div>
      <SOCGrid data={data} />
