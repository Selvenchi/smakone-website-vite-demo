          ...
          <div className="grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-1 gap-9 mt-4 place-items-center lg:mx-28 xl:mx-8">
            ...
            <div>
              <img
                ...
                className="object-cover md:w-screen lg:w-auto lg:h-64 xl:h-80 2xl:h-96"
                loading="lazy"
                alt="auditorium vokal"
              />
              <p className="justify-center text-center p-2">
                Auditorium Seni Vokal
              </p>
            </div>
            <div>
              <img
