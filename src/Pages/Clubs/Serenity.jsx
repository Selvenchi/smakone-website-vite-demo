      ...
      <div className="relative">
        ...
        <div className="px-10 xl:px-0 mx-auto -mt-28 relative mb-[3rem] z-10 bottom-0 flex flex-col max-w-[75rem] w-[100%] md:-mt-20">
          ...
          <p className="-mt-12 z-4 top-[85%] bg-white px-[1.2rem] py-[1rem] rounded-[2rem] shadow-2xl text-[0.75rem] sm:text-[1rem] leading-[17px] sm:leading-[20px] md:leading-8 md:text-[1.5rem] md:px-[2rem] md:py-[1.5rem]">
            SEREN1TY singkatan dari Smukiez Dance Crew in Dynamic Rythm &
            Diversity merupakan sebuah club tari di SMAK 1 PENABUR Jakarta yang
            bertujuan untuk mengembangkan kemampuan dan kreativitas perserta
            didik dalam membuat sebuah koreografi. Club tari ini mengembangkan
            berbagai genre tarian seperti kontemporer, modern dance, tari
            tradisional, B-boy, ladies, couple dan lain-lain.
