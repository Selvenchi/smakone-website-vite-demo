        ...
        <div className="px-4 sm:px-10 xl:px-0 mx-auto -mt-28 relative mb-12 z-10 flex flex-col max-w-4xl w-full md:-mt-20">
          ...
          <p className="-mt-12 z-10 bg-white px-6 py-4 rounded-3xl shadow-2xl text-sm sm:text-base md:text-xl md:px-10 md:py-6 flex flex-col border border-gray-100">
            <span className="mb-2 text-gray-700 leading-relaxed">
              Codeone adalah club coding yang berada dibawah OSIS bidang 9.
              Tugas kami meliputi memelihara dan juga memperbarui website{" "}
              <a
              ...
              secara berkelanjutan, serta beberapa website lain yang terkait
              kebutuhan sekolah seperti SOC, SAP, dan TEDx. Teknologi yang kami
              gunakan sebagian besar menggunakan JavaScript dengan React sebagai
              library front-end. Semua code pada website SMAK1 bersifat open
              source dan dapat diakses melalui link{" "}
              <a
            ...
            <span className="flex items-center justify-end gap-2 mt-4">
              <img className="w-6 md:w-7" src={github_logo} alt="Github" />
              <a
                href="https://github.com/codesmakone/SMAKONE"
                target="_blank"
