  ...
  return (
    <div class="px-10 xl:px-0 mx-auto mt-[5rem] relative z-3 bottom-0 flex flex-col max-w-[75rem] w-[100%]">
      <div class="border bg-gray-100 bg-white rounded-3xl shadow-2xl">
        <h2 class="border rounded-xl bg-white shadow-md mb-6 py-3 text-center font-bold text-3xl">
          Portofolio
        </h2>
        <div class="mt-5 md:mt-10 md:mb-10 md:mx-10 px-5 pb-5 h-[20rem] sm:h-[40rem] grid grid-cols-2 gap-2 md:gap-6 overflow-auto">
          ...
          <img
            ...
            src={Light1}
            alt="2 Member Mengatur Lighting"
          />
          ...
          <div class="relative col-start-1 row-start-3">
            <img
              class="relative h-auto w-full"
              src={CheckCam}
              alt="Member Memeriksa Hasil Foto"
            />
            <img
              class="relative h-auto w-full mt-2 md:mt-6"
              src={Light2}
              alt="Member Mengatur Lighting"
            />
          </div>
          <img
            class="relative h-full w-full col-start-2 row-start-3"
            src={Voli}
            alt="Bermain Voli"
          />
          <img
            class="relative h-auto w-full row-end-6"
            src={Camera2}
            alt="Camera Scenaric Version"
          />
          <img
            class="relative h-full w-full row-span-2 row-start-4 col-start-1 my-auto"
            src={F1RST}
            alt="F1RST"
          />
