...
const Penampilan = () => {
  return (
    <div className="container mx-auto md:mt-6 px-8 md:px-16 lg:px-24 xl:px-32 pt-10 justify-center">
      <div>
        <h2 className=" text-xl md:text-2xl xl:text-2xl font-semibold text-center">
          Clubs
        </h2>
        <h1 className="text-3xl md:text-5xl xl:text-5xl font-black text-center">
          Smukiez Youth Chamber
        </h1>
        <img
          src={TentangSYC}
          className="object-cover h-auto md:h-[20rem] lg:h-[32rem] xl:h-[30rem] max-w-auto mx-auto rounded-3xl my-6"
        />
        <p className="text-lg  mt-3 text-justify xl:px-10">
          SYC atau Smukiez Youth Chambers adalah klub orchestra SMAK 1 Penabur
          Jakarta yang memainkan berbagai genre lagu, meliputi klasik, pop, OST,
          game OST, dan lainnya. Dalam SYC, kita tidak hanya memainkan musik,
          tetapi juga mempelajari cara menciptakan lagu, mengaransemen, dan
          melatih/conducting latihan dan penampilan.
        </p>
      </div>

      <div className="mt-12">
        <h1 className="font-bold text-3xl text-center md:text-5xl">
          Video Penampilan SYC
        </h1>
        <div className=" mx-auto md:px-12 lg:px-16 xl:px-24">
          ...
          <div
            ...
            onClick={() =>
              window.open(
                "https://drive.google.com/drive/folders/1x9VAScghbzVWnsY8PIQXvi5kHzXEY7ZD?usp=drive_link",
                "_blank"
              )
            }
          >
