  ...
  return (
    <div>
      ...
      <div className="container w-full h-full mx-auto justify-center pb-5 mt-28">
        ...
        <ContentText text="Bel pulang sekolah berbunyi, menandakan selesainya segala kegiatan belajar mengajar di sekolah. Bagi beberapa siswa-siswi, istirahat usai sekolah merupakan suatu hal yang dapat menyegarkan pikiran dan waktu untuk melakukan kegiatan yang diinginkan. Tetapi, apakah yang biasanya smukiers lakukan?" />
