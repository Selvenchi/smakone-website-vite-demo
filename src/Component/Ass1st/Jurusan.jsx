    ...
    <div>
      ...
      <div className="container mx-auto mb-6 mt-28">
        ...
        <div className="pt-12 px-6 md:px-14 lg:px-28  xl:px-24 2xl:px-28">
          <img
            src={props.img}
            className="object-cover w-screen h-auto rounded-xl md:w-full md:rounded-3xl mt-6"
            alt={props.alt}
          />
        </div>
      </div>
      ...
      <h2 className="justify-left text-center text-3xl font-semibold px-2 pt-10 pb-2">
      ...
      <div className="grid lg:grid-cols-3 md grid-cols-1 gap-9 mt-4 place-items-center px-6 lg:mx-28 xl:mx-20">
        <div>
          <img
            src={props.world1img}
            className="md:w-screen lg:w-auto"
            alt={props.world1name}
          />
        ...
        <div>
          <img
            src={props.world3img}
            className="md:w-screen lg:w-auto"
            alt={props.world3name}
          />
          <p className="justify-center text-center p-2">{props.world3name}</p>
        </div>
      </div>
      <h2 className="justify-left text-center text-3xl font-semibold px-2 pt-4 pb-2">
        Top Universitas Asia
      </h2>
      <div className="grid lg:grid-cols-3 md grid-cols-1 gap-9 mt-4 place-items-center px-6 lg:mx-28 xl:mx-20">
        <div>
          <img
      ...
      <div className="flex justify-between mt-10 px-6 sm:px-16 lg:px-32 xl:px-24">
        <button
          onClick={() => navigate(-1)}
          className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-full text-sm sm:text-base md:text-lg lg:text-xl px-5 py-2.5 text-center sm:-ml-16 sm:-ml-8 lg:ml-0 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 "
        >
          Kembali
        </button>
        {props.dir && (
          <Link
            to={props.dir || props.dirBPH}
            className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none font-medium rounded-full text-sm sm:text-base md:text-lg lg:text-xl px-5 py-2.5 text-center sm:-mr-8 lg:mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 "
          >
            Artikel Berikutnya
          </Link>
        )}
